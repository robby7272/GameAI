...
public class ActionCreeperExplode extends GoapAction {
    //I think target would represent the herobrine object here
    public ActionCreeperExplode(Herobrine target) {
        super(target);
        this.addPrecondition(-1, "can_reach_player", false);
        this.addPrecondition(-1, "blocks_in_way", true);
        this.addPrecondition(-1, "player_above", false);
        this.addPrecondition(-1, "mob_in_control", "creeper");
        this.addEffect(-1, "blocks_in_way", false);
